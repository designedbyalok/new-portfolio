...
content = content.replace(/\.contact-pill\s*\{[^}]*font-size:\s*13px;/, match => match.replace('13px', 'var(--text-sm)'));
...
const printOverrides = `
    ...
    .edu-degree { font-size: 13px; }
    .edu-school { font-size: 12px; }
    .edu-date { font-size: 11px; }
    .skill-category { font-size: 12px; }
    .skill-tag { font-size: 11px; }
    .interest-tag { font-size: 11px; }
    .contact-pill { font-size: 12px; }`;
